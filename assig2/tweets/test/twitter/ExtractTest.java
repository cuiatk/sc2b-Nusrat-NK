...
public class ExtractTest {
    ...
    private static final Tweet tweet3 = new Tweet(3, "sharjeel", "@Rukhsar are your Kidding? ", d3);
    private static final Tweet tweet4 = new Tweet(4, "talal", "@Nusrat Lets have some fun:) ", d4);
    private static final Set<String> mentions = new HashSet<>(Arrays.asList("dave","rivest","nusrat","rukhsar"));
